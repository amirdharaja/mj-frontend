        ...
        <div id='footer'>
            <footer className="footer-distributed">
                <div className="footer-left">
                    ...
                    <p className="footer-company-name">Mother Juice © 2020</p>
                </div>
                ...
                <div className="footer-center">
                    ...
                    <div>
                        ...
                        <p><a href="mailto:supportmotherstore@ms.com">supportmotherjuice@mj.com</a></p>
                    </div>
