                  ...
                  <div id='address'>
                    ...
                    <form onSubmit={this.submitCheckoutForm}>
                          ...
                          {(this.props.address.length !== 0) ?
                            <div>
                              <select id='select-address' onChange={this.shippingAddressController}>
                                <option name='address'>Select Address</option>
                      ...
                      {!this.state.payment_type
                        ...
                        : <button id='checkout-button' type="submit" onClick={this.submitCheckoutForm}>Confirm & Pay via {this.state.payment_type} <span style={{ fontWeight: 'normal' }}>(₹ {this.props.cart_total_amount})</span></button>
                      }
                      <hr />
                    </form>
                  </div>
                        ...
                        return (
                          <div key={index}>
                            <table>
                              <tbody>
                                <tr>
                                  <td id='a'>{item.count} x {item.name} ({item.weeks} weeks)</td>
                                  <td id='b'>₹ {item.count * item.rate_per_week * item.weeks}</td>
                                </tr>
                              </tbody>
                            </table>
                            <hr />
